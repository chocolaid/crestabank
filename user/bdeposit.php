...
function showSnackbar($message, $type = 'info') {
    echo "<script>
        window.onload = function() {
            Snackbar.show({text: '$message', pos: 'top-right', backgroundColor: '$type'});
        };
    </script>";
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['deposit'])) {
    ...
    if (!filter_var($amount, FILTER_VALIDATE_FLOAT)) {
        showSnackbar('Invalid amount.', 'red');
        exit;
    }

    $valid_crypto_names = ["1", "56"];
    if (!in_array($crypto_name, $valid_crypto_names)) {
        showSnackbar('Invalid crypto type.', 'red');
        exit;
    }

    if (empty($wallet_address)) {
        showSnackbar('Wallet address is required.', 'red');
        exit;
    }
    ...
    if ($_FILES["image"]["size"] > $max_file_size) {
        showSnackbar('File too large.', 'red');
        $upload_ok = 0;
    }

    $allowed_types = ["jpg", "jpeg", "png", "gif"];
    if (!in_array($image_file_type, $allowed_types)) {
        showSnackbar('Sorry, only JPG, JPEG, PNG & GIF files are allowed.', 'red');
        $upload_ok = 0;
    }

    if ($upload_ok == 0) {
        showSnackbar('Sorry, your file was not uploaded.', 'red');
    } else {
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $upload_file)) {
            // File uploaded successfully
        } else {
            showSnackbar('Sorry, there was an error uploading your file.', 'red');
            exit;
        }
    }
    ...
    $message = '<h2>Transaction Details</h2>'
             ...
             . '<p>Account Number: ' . htmlspecialchars($account_number) . '</p>'
    ...
    try {
        ...
        $mail->send();
        showSnackbar('Deposit information sent successfully.', 'green');
    } catch (Exception $e) {
        showSnackbar('Mailer Error: ' . $mail->ErrorInfo, 'red');
    }
}
?>
...
<head>
    ...
    <title>Funding - Cresta Bank </title>
                                ...
                                <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <button class="btn btn-primary mb-2 mr-2" name="deposit" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg> Complete Deposit</button>
                                       ...
                                       <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group ">
                                                        <input type="text" class="form-control" name="bank_name" id="bank_name" placeholder="" value=""
                                                               aria-label="notification" aria-describedby="basic-addon1"
                                                               readonly>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group ">
                                                        <input type="text" class="form-control" name="acct_no" id="acct_no" placeholder="" value=""
                                                               aria-label="notification" aria-describedby="basic-addon1"
                                                               readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group ">
                                                        <input type="text" class="form-control" name="routine_no" id="routine_no" placeholder="" value=""
                                                               aria-label="notification" aria-describedby="basic-addon1"
                                                               readonly>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group ">
                                                        <input type="text" class="form-control" name="paypal" id="paypal" placeholder="" value=""
                                                               aria-label="notification" aria-describedby="basic-addon1"
                                                               readonly>
                                                        <a class="btn btn-primary sm-2" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#paypal"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg> Copy</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    ...
                                                    <div class="input-group ">
                                                        <input type="text" class="form-control" name="zelle" id="zelle" placeholder="" value=""
                                                               aria-label="notification" aria-describedby="basic-addon1"
                                                               readonly>
                                                        <a class="btn btn-primary sm-2" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#zelle"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg> Copy</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group mb-4 mt-4">
                                                    <label for="">Cashapp</label>
                                                    <div class="input-group ">
                                                        <input type="text" class="form-control" name="cashapp" id="cashapp" placeholder="" value=""
                                                               aria-label="notification" aria-describedby="basic-addon1"
                                                               readonly>
                                                        <a class="btn btn-primary sm-2" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#cashapp"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-copy"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"></rect><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"></path></svg> Copy</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    var data = [{"id":"4","wallet_address":""},{"id":"1","wallet_address":""},{"id":"3","wallet_address":""},{"id":"2","wallet_address":""}];
    console.log(data);
...
<script>
    ...
    var targetdestination="./success.php"
...
<script>
    ...
    //         url : "www.westlightbank.site/include/process-file.php",
    //         dataType: 'JSON',
