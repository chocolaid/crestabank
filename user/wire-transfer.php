...
<head>
    ...
    <title>Wire Transfer - Cresta Bank </title>
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                    ...
                    <div class="dropdown-menu p-0 position-absolute" aria-labelledby="messageDropdown">
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    ...
                                    <div class="media">
                                        <p class="text-primary media-body">No new messages</p>
                ...
                <li class="nav-item dropdown notification-dropdown">
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="notificationDropdown">
                        ...
                        <p class="text-primary text-center">No new notifications</p>
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <button id="showp" class="btn btn-primary mb-2 mr-2" name="wire_trans"><svg
