                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a class="btn btn-primary sm-2" href="./bdeposit.php">Next</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    var data = [{"id":"1","wallet_address":"bc1qdrr90d2mq48euglkkm3t82ctv32jyntq8c2m03"},{"id":"56","wallet_address":"TQEhog4xNtkEmuUqyzFa7QgReBr8FKWjm4"}];
    console.log(data);
