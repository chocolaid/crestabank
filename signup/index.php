...
<head>
    ...
    <title>Registration - CRESTA Bank </title>
    ...
    <script src="../../www.dukelearntoprogram.com/course1/common/js/image/SimpleImage.js">
    
    </script>
    <script>
        // Function to show Snackbar with message and background color
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Check if there was a session flag set (e.g., login errors)
            <?php
...
<section class="wizard-section">
    <div class="row no-gutters">
        <div class="col-lg-6 col-md-6 container-div">
            <div>
                <center><a href="../index.php"><img src="../images/logo.png" class="navbar-logo" alt="logo" width="50%" style="margin-top:5px; margin-bottom: 5px"></a></center>
                </div>
                ...
                <form action="#" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <fieldset class="wizard-fieldset show">
                        ...
                        <div class="form-group">
                           ...
                           <div class="wizard-form-radio">
                               <input name="radio-name" id="radio3" type="radio" value="Other">
                        ...
                        <div class="form-group clearfix">
                            <a href="../index.php" class="form-wizard-next-btn float-left">Home</a>
                    ...
                    <fieldset class="wizard-fieldset">
                        ...
                        <p>We are required by law to collect your Social Security Number / TIN.</p>
                        <div id="Div1">
                            <div class="container">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        Applying for CRESTA BANK Account will never impact your credit score
                                    </div>
                                </div>
                    ...
                    <fieldset class="wizard-fieldset text-white">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" name="backID" id="backDoc" required />
                            </div>
                        </div>
...
<!-- Mirrored from CRESTAbank.site/signup/verify-registration.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Jun 2024 20:53:23 GMT -->
</html>